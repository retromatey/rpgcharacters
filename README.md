...
- Generates a level 1 character for the Basic Fantasy RGP game
...
**Interactive mode** enables the user to pick the character's race and class based
off of dice roles that have determined the character's ability scores. The user
also has the opportunity to name the character and save the character's stats to
a file.
